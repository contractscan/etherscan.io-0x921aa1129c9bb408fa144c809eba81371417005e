...
// File erc721a-upgradeable/contracts/extensions/IERC721AQueryableUpgradeable.sol@v4.2.3
// License-Identifier: MIT
// ERC721A Contracts v4.2.3
// Creator: Chiru Labs
...
// File erc721a-upgradeable/contracts/extensions/ERC721AQueryableUpgradeable.sol@v4.2.3
// License-Identifier: MIT
// ERC721A Contracts v4.2.3
// Creator: Chiru Labs
...
// File @openzeppelin/contracts-upgradeable/utils/cryptography/MerkleProofUpgradeable.sol@v4.8.1
// License-Identifier: MIT
...
// File contracts/MistfitsNFT.sol
// License-Identifier: MIT
    ...
    ReentrancyGuardUpgradeable
{
    ...
    modifier reserveCompliance() {
        ...
        require(!reserveClaimed[_msgSender()], "Already reserved!");
    ...
    constructor() initializerERC721A initializer {
        __Pausable_init();
        _pause();
    }
    ...
    function setWalletAddress(address payable _walletAddress) external onlyOwner {
        walletAddress = _walletAddress;
    }
    ...
    function setReservelist(address[] calldata _reserveAddresses) external onlyOwner {
    ...
    function setMintEnabled(bool _whitelistMintEnabled, bool _publicMintEnabled) external onlyOwner {
    ...
    ) external payable whenNotPaused nonReentrant mintComplianceWhitelist(_mintAmount) {
    ...
    function mint(
        uint256 _mintAmount
    ) external payable whenNotPaused nonReentrant mintCompliancePublic(_mintAmount) {
        _safeMint(_msgSender(), _mintAmount);
        if (walletAddress != address(0)) {
            (bool success, ) = walletAddress.call{value: address(this).balance}(
                ""
    ...
    function reserve() external whenNotPaused nonReentrant reserveCompliance {
        ...
        reserveClaimed[_msgSender()] = true;
    }
